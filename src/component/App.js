...
export default class App extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      customDateRulesCategories: this.getFilteredCategory(rule => rule.isCustomDate),
      submitWhenChangeCategories: this.getFilteredCategory(rule => rule.isSubmitWhenChange),
  ...
  render() {
    return (
      <>
        <Row>
          ...
          <Col span={18}>
            <Row>
              ...
              <Col span={5}>
                <FilteredCategoryRules title='个性化时间点' categories={this.state.customDateRulesCategories} />
                <FilteredCategoryRules title='有变化才提交' categories={this.state.submitWhenChangeCategories} />
              </Col>
              <Col span={7}>
                <FilteredCategoryRules title='长期坚持' categories={this.state.irregularCategories} />
              </Col>
            </Row>
          </Col>
        </Row>
        ...
        <Row>
          <Col span={6}>
            <FilteredCategoryRules title='全部' categories={this.state.categories} />
          </Col>
        </Row>
      </>
    );
